...
public class ListUserRoleService {
    ...
    public ListUserRole findByItemListAndRole(ItemList itemList, Role role) {
        return listUserRoleRepository.findByItemListAndRole(itemList, role).orElseThrow(() ->  new EntityNotFoundException());
    }
}
